                ...
                <li key={link.href}>
                  <a
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "bg-accent-3 font-medium text-accent after:absolute after:-bottom-1 after:left-1/2 after:h-[2px] after:w-4 after:-translate-x-1/2 after:rounded-full after:bg-gold after:content-['']"
