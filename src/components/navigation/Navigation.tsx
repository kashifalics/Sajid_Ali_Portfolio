    ...
    <header ref={headerRef} className="fixed inset-x-0 top-4 z-50 px-4 sm:px-6">
      <div className="mx-auto w-full max-w-[1240px]">
        ...
        >
              ...
              return (
                <li key={link.href}>
                  <a
                    ...
                    className={cn(
                      "block rounded-full px-3.5 py-1.5 text-sm transition-colors duration-200 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-accent",
                      isActive
          ...
          <div className="hidden items-center gap-3 lg:flex">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-hairline-strong bg-surface px-4 py-2 text-sm font-medium text-fg transition-colors hover:border-accent hover:text-accent focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-accent"
            >
        ...
        {open ? (
          <div
            id="mobile-menu"
            className="mt-2 rounded-[20px] border border-[rgba(17,24,39,0.08)] bg-white/95 px-4 pb-4 pt-2 shadow-[0_10px_30px_-15px_rgba(17,24,39,0.3)] backdrop-blur-md lg:hidden"
          >
            ...
            <a
              ...
              className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-full border border-hairline-strong bg-surface px-5 py-3 text-sm font-medium text-fg hover:border-accent hover:text-accent"
            >
              <LinkedInIcon className="h-[18px] w-[18px]" />
              LinkedIn
            </a>
